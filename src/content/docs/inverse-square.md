...
挙げ出すと、まだまだ出てくる。**電場** ── 点電荷が作る場 $E=\frac{1}{4\pi\varepsilon_0}\dfrac{q}{r^2}$ は、この $1/r^2$ の代表選手だ（クーロンの法則のあの $r^2$ も、結局は球面の面積のこと）。**電波** もそう ── アンテナから放たれた電力は球面に薄まるので、受信できる電力は $1/r^2$ で落ちていく。無線屋が「自由空間の伝搬損失」と呼ぶやつで、距離が2倍になれば受信は $1/4$ だ。**天文** では、この $1/r^2$ がそのまま“ものさし”になる ── 本当の明るさが分かっている星（標準光源）の、見かけの暗さを測れば、$1/r^2$ を逆に解いて距離が出る。宇宙までの遠さは、この逆二乗で測られているんだよ。
...
（この “簿記” は、力学の側から見ると [仕事と力学的エネルギー](/docs/work-energy/) の **状態量と流量** という分け方と、ぴたり同じ話だ。面を貫いて流れていくフラックスは “流量”、湧かず消えず保たれる源の強さは “状態量” ── 同じ簿記を、片や場、片やエネルギーから覗いているだけだよ。）
