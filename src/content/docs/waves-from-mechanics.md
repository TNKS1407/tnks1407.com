...
<svg viewBox="0 0 460 185" width="460" style="max-width:100%;height:auto;font-family:'JetBrains Mono',monospace;">
  <line x1="50" y1="150" x2="435" y2="150" stroke="#1d1b17" stroke-width="1.2"/>
  <line x1="50" y1="20" x2="50" y2="150" stroke="#1d1b17" stroke-width="1.2"/>
  <text x="56" y="30" font-size="10" fill="#7d7568">ω（揺れの速さ）</text>
  <text x="435" y="167" font-size="10" fill="#7d7568" text-anchor="end">モード番号 j（短い波 →）</text>
  <polyline points="50.0,150.0 60.0,146.8 70.0,143.5 80.0,140.3 90.0,137.0 100.0,133.8 110.0,130.5 120.0,127.3 130.0,124.1 140.0,120.8 150.0,117.6 160.0,114.3 170.0,111.1 180.0,107.8 190.0,104.6 200.0,101.4 210.0,98.1 220.0,94.9 230.0,91.6 240.0,88.4 250.0,85.1 260.0,81.9 270.0,78.6 280.0,75.4 290.0,72.2 300.0,68.9 310.0,65.7 320.0,62.4 330.0,59.2 340.0,55.9 350.0,52.7 360.0,49.5 370.0,46.2 380.0,43.0 390.0,39.7 400.0,36.5 410.0,33.2 420.0,30.0" fill="none" stroke="#c9761f" stroke-width="1.8" stroke-dasharray="5 3"/>
  <polyline points="50.0,150.0 60.0,146.8 70.0,143.5 80.0,140.3 90.0,137.1 100.0,133.9 110.0,130.8 120.0,127.6 130.0,124.5 140.0,121.5 150.0,118.5 160.0,115.6 170.0,112.7 180.0,109.9 190.0,107.2 200.0,104.6 210.0,102.0 220.0,99.5 230.0,97.1 240.0,94.8 250.0,92.7 260.0,90.6 270.0,88.6 280.0,86.7 290.0,84.9 300.0,83.3 310.0,81.8 320.0,80.4 330.0,79.1 340.0,78.0 350.0,77.0 360.0,76.1 370.0,75.3 380.0,74.7 390.0,74.2 400.0,73.9 410.0,73.7 420.0,73.6" fill="none" stroke="#3c7876" stroke-width="2"/>
  <line x1="420" y1="30" x2="420" y2="73.6" stroke="#c2543d" stroke-width="1" stroke-dasharray="2 2"/>
  <text x="150" y="104" font-size="10" fill="#c9761f">理想のなめらかなひも（直線）</text>
  <text x="300" y="92" font-size="10" fill="#3c7876">実際のつぶつぶの鎖</text>
  <text x="86" y="142" font-size="9.5" fill="#7d7568">長い波＝一致</text>
  <text x="330" y="50" font-size="9.5" fill="#c2543d">短い波＝ずれる（分散）</text>
</svg>
<figcaption style="font-size:.8rem;color:#aaa49b;margin-top:.3rem;">直線（橙・理想のひも）と実際の鎖（緑）。長い波（左）ではぴったり重なるのに、短い波（右）ほど鎖は遅れて下に曲がる ── この差が分散。赤い隙間が、つぶつぶの鎖となめらかなひもの“ずれ”だよ。</figcaption>
</figure>
