...
ただし SPI も I²C も、想定しているのは **基板の上の、数センチ〜十数センチ**だ。クロックを共有する以上、線が長くなるとエッジが鈍り、ノイズに弱くなる。「もっと遠くへ」「もっとたくさん、長い距離でぶら下げたい」となると、別の作りが要る。

そこで次は、電圧の持ち方を **差動** に変えて、一本のバスに大勢を、長い距離でつなぐ ── **RS-485**（と、その上で話す Modbus）へ進む。UART で握った start/stop とボーレートが、今度は「遠く・多数」の世界で、もう一度効いてくる。土台に、二段目を積もう。
